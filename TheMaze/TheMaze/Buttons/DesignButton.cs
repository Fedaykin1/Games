...
namespace TheMaze.Buttons
{
    ...
    {
        static string info_bulle = "Change Design";
        public DesignButton(Texture2D i_texture, Vector2 i_position) : base(i_texture, i_position, info_bulle)
        {
            offset = -40;
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                LevelManager.Instance.ChangeDesign();
            }
